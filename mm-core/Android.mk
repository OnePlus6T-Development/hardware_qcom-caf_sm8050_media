...
else ifeq ($(filter $(TARGET_BOARD_PLATFORM), sm8050),$(TARGET_BOARD_PLATFORM))
OMXCORE_CFLAGS += -D_SDM845
else
...
ifneq (,$(filter msmnile sdmshrike $(MSMSTEPPE) $(TRINKET) atoll sdm845 sm8050,$(TARGET_BOARD_PLATFORM)))
